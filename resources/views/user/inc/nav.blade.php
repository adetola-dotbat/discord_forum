<nav id="topnav" class="defaultscroll is-sticky">
    <div class="container">
        ...
        <a class="logo" href="index.html">
            ...
            <img src="assets/images/logo-light.png" class="hidden" alt="">
        </a>
        ...
        <ul class="buy-button list-none mb-0">
            ...
            <li class="inline ps-1 mb-0">
                <a href="https://1.envato.market/techwind" target="_blank"
                    class="btn rounded-full bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white">Get
                    Started</a>
            </li>
        </ul>
        <!--Login button End-->
                    ...
                    <ul class="submenu megamenu">
                        ...
                        <li>
                            <ul>
                                ...
                                <li><a href="index-yoga.html" class="sub-menu-item">Yoga <span
                                            class="bg-orange-600 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <ul>
                                ...
                                <li><a href="index-corporate-two.html" class="sub-menu-item">Corporate Two </a>
                                </li>
                    ...
                    <ul class="submenu">
                        ...
                        <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> Job / Careers
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="page-job-candidates.html" class="sub-menu-item">Job Candidates</a>
                                </li>
                                ...
                                <li><a href="page-job-company-detail.html" class="sub-menu-item">Company
                                        Detail</a></li>
                            </ul>
                        </li>
                            ...
                            <ul class="submenu">
                                ...
                                <li class="has-submenu child-menu-item"><a href="javascript:void(0)"> Blog Posts
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li><a href="blog-gallery-post.html" class="sub-menu-item">Gallery
                                                Post</a></li>
                                        <li><a href="blog-youtube-post.html" class="sub-menu-item">Youtube
                                                Post</a></li>
                                        <li><a href="blog-vimeo-post.html" class="sub-menu-item">Vimeo Post</a>
                                        </li>
                                        <li><a href="blog-audio-post.html" class="sub-menu-item">Audio Post</a>
                                        </li>
                    ...
                    <ul class="submenu megamenu">
                        ...
                        <li>
                            <ul>
                                ...
                                <li><a href="portfolio-classic-four.html" class="sub-menu-item">Four Column</a>
                                </li>
                                <li><a href="portfolio-classic-five.html" class="sub-menu-item">Five Column</a>
                                </li>
                        ...
                        <li>
                            <ul>
                                ...
                                <li><a href="portfolio-creative-two.html" class="sub-menu-item">Two Column</a>
                                </li>
                                ...
                                <li><a href="portfolio-creative-six.html" class="sub-menu-item">Six Column</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <ul>
                                ...
                                <li><a href="portfolio-detail-one.html" class="sub-menu-item">Portfolio One</a>
                                </li>
                                <li><a href="portfolio-detail-two.html" class="sub-menu-item">Portfolio Two</a>
                                </li>
                                <li><a href="portfolio-detail-three.html" class="sub-menu-item">Portfolio
                                        Three</a></li>
